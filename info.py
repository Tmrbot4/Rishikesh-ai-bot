...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6968522427:AAFJUyIo7lOJutnqwpo2xMYtWp7XRFNTl1g') #bot token from botfather
if len(BOT_TOKEN) == 0:
...
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1002173111279').split()]
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002197485122') #support group id ex:  -1002936246860
...
URL = environ.get("URL", "https://outrageous-marillin-vishalbot-2e0f5b35.koyeb.app/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
